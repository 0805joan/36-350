...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/0805joan/36-350/main/README.md")
```
...
source_url("https://raw.githubusercontent.com/0805joan/36-350/main/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/0805joan/36-350/main/dark_and_stormy.R")
source_url("https://raw.githubusercontent.com/0805joan/36-350/new_branch/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/0805joan/36-350-Fork/main/check_mark.R")
```
...
test_that(desc = "Test for non-letter", expect_error(f(1)))
test_that(desc = "Test for expected output length (1)", expect_equal(f("a"),1))
test_that(desc = "Test for expected output length (1)", expect_equal(f("A"),1))
test_that(desc = "Test for character length greater than 1", expect_error(f("ab")))
test_that(desc = "Test for expected output length(0.6931472", expect_error(f("0")))
```
...
f = function(x) {
  ...
  if (nchar(x) != 1) {
    stop("The input must have length 1")
  }
  if (length(x) != 1) {
    stop("The input must be a character vector of length 1")
  }
  return(log(which(letters==tolower(x))))
}
test_that(desc = "Test for non-letter", expect_error(f(1)))
test_that(desc = "Test for expected output length (1)", expect_equal(f("a"),0))
test_that(desc = "Test for expected output length (1)", expect_equal(f("A"),0))
test_that(desc = "Test for character length greater than 1", expect_error(f("ab")))
test_that(desc = "Test for expected output length(0.6931472", expect_error(f(.)))
```
